...
class AgentState(TypedDict, total=False):
    ...
    disclosure_quality: Optional[dict]
    # 确定性披露质量评分：完整性、连续性、可比性、可验证性、具体性 + 风险信号

    greenwashing_risks: Optional[dict]
    # 规则型绿漂风险雷达：识别“强 ESG 表述但附近证据不足”的 claim-evidence mismatch
