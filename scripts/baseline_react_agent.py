...
# Baseline uses the same OpenAI-compatible provider/model as the main Agent by default.
# This controls the model variable so the comparison focuses on workflow/evaluator effects.
QWEN_API_KEY: str = os.getenv("BASELINE_API_KEY") or os.getenv("OPENAI_API_KEY") or os.getenv("QWEN_API_KEY", "")
QWEN_BASE_URL: str = os.getenv("BASELINE_BASE_URL") or os.getenv("OPENAI_BASE_URL") or os.getenv(
    "QWEN_BASE_URL", "https://dashscope-intl.aliyuncs.com/compatible-mode/v1"
)
QWEN_MODEL: str = os.getenv("BASELINE_MODEL") or os.getenv("OPENAI_MAIN_MODEL") or os.getenv("QWEN_EVAL_MODEL", "qwen3-235b-a22b")
...
if not QWEN_API_KEY:
    raise EnvironmentError(
        "No baseline API key found. Configure BASELINE_API_KEY, OPENAI_API_KEY, or QWEN_API_KEY."
    )
...
class QwenChatModel(BaseChatModel):
    ...
    def _generate(
        ...
        **kwargs: Any,
        ...
        if "dashscope" in QWEN_BASE_URL.lower():
